...
<body>
    ...
    <footer class="footer">
        ...
        <p class="footer-text">
            本项目作为中立工具，不存储任何资源。用户对通过本工具访问的内容负全部法律责任。
        </p>
        <p class="footer-text">如有任何侵权行为，请联系站点负责人快速处理：admin@epocanvas.com</p>
        <p class="footer-text">本项目完全免费，不收取任何费用，请勿上当受骗。</p>
        <p class="footer-links">
            <a href="https://t.me/epocanvas_bot" target="_blank" class="footer-link">💬 TG MSG ROBOT</a>
